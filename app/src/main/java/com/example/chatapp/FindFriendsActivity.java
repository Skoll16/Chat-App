...
public class FindFriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTool=(Toolbar)findViewById(R.id.find_friends_toolbar);
    ...
    protected void onStart() {
      ...
      FirebaseRecyclerAdapter<Contacts,Findfriendsviewholder> adapter=new FirebaseRecyclerAdapter<Contacts, Findfriendsviewholder>(options) {
          ...
          protected void onBindViewHolder(@NonNull Findfriendsviewholder holder, final int position, @NonNull Contacts model) {
              ...
              holder.userStatus.setText(model.getAbout());
              ...
              holder.itemView.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                      ...
                      String user_id_click=getRef(position).getKey();
                      Intent intent=new Intent(FindFriendsActivity.this,ProfileActivity.class);
                      intent.putExtra("user_id_click",user_id_click);
